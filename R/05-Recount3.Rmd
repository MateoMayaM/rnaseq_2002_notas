...
Son datos procesados de manera uniforme.  
...
Las dos funciones más importantes al descargar datos de recount3 son ```compute_read_counts``` y ```expand_sra_attributes```
